...
#1.question 1:creating a class
class Brewery:
   
   #1.question 2:creating init constructor
...
if __name__== '__main__':
  ...
  #2.question 4:printing and calling different methods of class
  ...
  #2.question 3:types of brewery present in individual cities of state mentioned above 
